...
type SocialLinksVariant = "inline" | "list" | "icons";
    ...
    return (
      <div className={cn("flex items-center gap-4", className)}>
        <a
          ...
          className="text-zinc-500 transition-colors hover:text-indigo-500 dark:text-zinc-400 dark:hover:text-indigo-400"
        ...
        <Link href="/contact" className={cn("text-sm font-medium", linkClassName)}>
          Get in touch
        </Link>
      </div>
    );
